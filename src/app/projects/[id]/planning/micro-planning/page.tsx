      ...
      <Card className="shadow-md">
        ...
        <CardContent className="space-y-6">
          {/* Wrap with DragDropContext */}
            ...
            <SprintList sprints={sprints} isLoading={isLoadingSprints} error={sprintsError} droppableId="sprint-list" />

            <div className="flex justify-between items-center mt-6">
              <h3 className="text-lg font-semibold">Backlog Tasks</h3>
            </div>
            {/* Use the extracted Backlog component */}
            <Backlog backlogTasks={backlogTasks} isLoading={isLoadingBacklogTasks} error={backlogTasksError} droppableId="backlog-tasks" />
